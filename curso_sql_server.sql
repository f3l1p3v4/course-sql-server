...
/*
Funcoes de Manipulação de Strings
- CONCAT - LEN - LOWER - UPPER - LTRIM - RTRIM - TRIM - LEFT - RIGHT - REPLACE - SUBSTRING

CONCAT: Junta dois ou mais textos em um só.
...
LTRIM: Remove os espaços em branco inúteis do lado esquerdo (Left).

RTRIM: Remove os espaços em branco do lado direito (Right).

TRIM: Remove os espaços de ambos os lados. É a faxina completa.

LEFT: Pega uma quantidade "X" de caracteres começando da esquerda.
	Ex: LEFT('Banana', 2) → 'Ba'

RIGHT: Pega uma quantidade "X" de caracteres começando da direita.
	Ex: RIGHT('Banana', 2) → 'na'

REPLACE: Procura um trecho específico e o substitui por outro.
	Ex: REPLACE('Gato', 'G', 'R') → 'Rato'
